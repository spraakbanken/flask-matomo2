...
- Import typing as t, use t.Any in code by [@kod-kristoff](https://github.com/kod-kristoff)
- Import httpx2 as httpx by [@kod-kristoff](https://github.com/kod-kristoff)
- Use MatomoCore for all tracking_state logic by [@kod-kristoff](https://github.com/kod-kristoff)
- Use HTTP_METHODS from matomo-core by [@kod-kristoff](https://github.com/kod-kristoff)
- Use tracker from matomo-core by [@kod-kristoff](https://github.com/kod-kristoff)

### Documentation

- Link to correct repo by [@kod-kristoff](https://github.com/kod-kristoff)

### Internal

- Bump project.requires to >= 3.10 by [@kod-kristoff](https://github.com/kod-kristoff)
- Match ua as str by [@kod-kristoff](https://github.com/kod-kristoff)

### Removed

- _(deps)_ Remove httpx by [@kod-kristoff](https://github.com/kod-kristoff)
- Remove mypy by [@kod-kristoff](https://github.com/kod-kristoff)
- Remove nightly step in rolling workflow by [@kod-kristoff](https://github.com/kod-kristoff)
